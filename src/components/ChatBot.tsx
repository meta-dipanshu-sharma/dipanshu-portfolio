...
export function ChatBot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hi! I'm Dipanshu's portfolio assistant. Ask me anything about his experience, skills, or availability.",
    },
  ]);
          ...
          {open ? (
            ...
            >
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden>
                <path d="M2 4a2 2 0 012-2h12a2 2 0 012 2v9a2 2 0 01-2 2H6l-4 3V4z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
                <path d="M6 7h8M6 10.5h5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
              </svg>
            </motion.span>
          )}
        </AnimatePresence>
        {!open && <span className="chatbot__trigger-label">Ask me anything</span>}
      </motion.button>
          ...
          >
            ...
            <div className="chatbot__header">
              <div className="chatbot__header-info">
                ...
                <div>
                  <div className="chatbot__header-name">Portfolio Assistant</div>
                  <div className="chatbot__header-sub">Powered by Llama 3 · Groq</div>
                </div>
              </div>
              <button
            ...
            <div className="chatbot__messages">
              {messages.map((msg, i) => (
                ...
                >
                  {msg.role === 'assistant' && (
                    <span className="chatbot__msg-avatar" aria-hidden>Ds</span>
                  )}
